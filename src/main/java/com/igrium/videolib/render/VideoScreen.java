...
public class VideoScreen extends Screen {
    ...
    protected record SimpleQuad(float x0, float y0, float x1, float y1, float u0, float v0, float u1, float v1){
        ...
        public void render(Identifier texture, MatrixStack ms) {
    ...
    public void render(MatrixStack ms, int mouseX, int mouseY, float delta) {
        ...
        calculateQuad(player.getCodecInterface().getAspectRatio()).render(player.getTexture(), ms);
    }
    ...
    public void renderBackground(MatrixStack ms, int vOffset) {
        fill(ms, 0, 0, width, height, backgroundColor);
    }
